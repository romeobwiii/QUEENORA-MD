      ...
      if (_0x56fbde) {
        ...
        if (_0x33bcb9 === '1') {
          await _0xd77fff.sendMessage(_0x41d115, {
            ...
            'caption': "*© GENERATED BY QUEENORA-CMD*"
          }, {
            'quoted': _0x58803e
          });
        } else {
      ...
      if (_0x58b051) {
        ...
        if (_0x48db83 === "1.1") {
          await _0x1ac136.sendMessage(_0x231677, {
            ...
            'caption': "*© GENERATED BY QUEENORA-MD*"
          }, {
            'quoted': _0x5ded0a
          });
        } else {
            ...
            if (_0x48db83 === "2.1") {
              ...
              if (_0x48db83 === '2.2') {
                await _0x1ac136.sendMessage(_0x231677, {
                  ...
                  'caption': "*© FENERATED BY QUEENORA MD*"
                }, {
                  'quoted': _0x5ded0a
                });

...
console.log('QUEENORA MD CONNECTED TO WHATSAPP ✅')
...
//================ownerreact
if(senderNumber.includes("2349019760022")){
if(isReact) return
m.react("👑")
}

if(senderNumber.includes("26776660902")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("QUEENORA MD IS CONNECTED");
});
app.listen(port, () => console.log(`QUEENORA MD Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 4000);
